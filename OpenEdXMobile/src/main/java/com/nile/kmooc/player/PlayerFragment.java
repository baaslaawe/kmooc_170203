...
import com.nile.kmooc.util.ListUtil;
...
public class PlayerFragment extends BaseFragment implements IPlayerListener, Serializable,
    ...
    private static final int DELAY_TIME_MS = 10000;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.nile.kmooc.R.layout.panel_player, null);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        try {
            ...
            getView().findViewById(com.nile.kmooc.R.id.panel_video_only_on_web).setOnClickListener(new OnClickListener() {
                @Override
    ...
    public void onStart() {
        ...
        stateSaved = false;
        try{
            Preview preview = (Preview) getView().findViewById(com.nile.kmooc.R.id.preview);
            if(player!=null){
    ...
    private void showProgress() {
        try {
            ...
            if( this.curMessageTypes.isEmpty() ){
                getView().findViewById(com.nile.kmooc.R.id.loading_indicator).setVisibility(View.VISIBLE);
            }
        } catch(Exception ex) {
            logger.error(ex);
        }
    ...
    private void hideProgress() {
        try {
            getView().findViewById(com.nile.kmooc.R.id.loading_indicator).setVisibility(View.GONE);
        } catch(Exception ex) {
            logger.error(ex);
        }
    }
    ...
    private void setupController() {
        ...
        try {
            ...
            final ViewGroup container = (ViewGroup) f
                    .findViewById(com.nile.kmooc.R.id.preview_container);
    ...
    private void hideNetworkError() {
        try {
            unlockOrientation();
            View errorView = getView().findViewById(com.nile.kmooc.R.id.panel_network_error);
        ...
        try {
            if(player!=null){
                ...
                if ( reason == VideoNotPlayMessageType.IS_VIDEO_MESSAGE_DISPLAYED)
                    errorView = getView().findViewById(com.nile.kmooc.R.id.panel_video_not_available);
                else
                    errorView = getView().findViewById(com.nile.kmooc.R.id.panel_video_only_on_web);
                errorView.setVisibility(View.VISIBLE);
    ...
    private Runnable subtitleProcessesor = new Runnable() {
        ...
        public void run() {
            try{
                ...
                subtitleDisplayHandler.postDelayed(this, 1000);
            }catch(Exception e){
                logger.error(e);
            }
        }
            ...
            try
            {
                ...
                if (localHashMap != null){
                    ...
                    if ((srtList == null) || (srtList.size() == 0)) {
                        subtitleFetchHandler.postDelayed(subtitleFetchProcessesor, 1000);
                    }else{
                        displaySrtData();
                    }
                }else{
    ...
    private void setClosedCaptionData(Caption text){
        try{
            RelativeLayout subTitlesLayout = (RelativeLayout) getActivity().findViewById(com.nile.kmooc.R.id.txtSubtitles);
            TextView subTitlesTv = (TextView) getActivity().findViewById(com.nile.kmooc.R.id.txtSubtitles_tv);
            if(subTitlesTv!=null ){
                if(text!=null){
    ...
    public void callSettings(Point p) {
        try{
            ImageView iv = (ImageView) getActivity().findViewById(com.nile.kmooc.R.id.iv_transparent_bg);
    ...
    private void showSettingsPopup(final Point p) {
        try{
            if(player!=null){
                ...
                LinearLayout viewGroup = (LinearLayout) context.findViewById(com.nile.kmooc.R.id.setting_popup);
                LayoutInflater layoutInflater = (LayoutInflater) context
                        .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                View layout = layoutInflater.inflate(com.nile.kmooc.R.layout.panel_settings_popup, viewGroup);
                ...
                TextView tv_closedCaption = (TextView) layout.findViewById(com.nile.kmooc.R.id.tv_closedcaption);
                if ((langList != null) && (langList.size() > 0))
                {
                    tv_closedCaption.setBackgroundResource(com.nile.kmooc.R.drawable.white_rounded_selector);
                    ...
                    tv_closedCaption.setBackgroundResource(com.nile.kmooc.R.drawable.grey_roundedbg);
    ...
    private void showClosedCaptionLandscapePopup(Point p){
        try{
            ...
            LinearLayout viewGroup = (LinearLayout) getActivity()
                    .findViewById(com.nile.kmooc.R.id.cc_layout_popup);

            View layout = layoutInflater.inflate(com.nile.kmooc.R.layout.panel_cc_popup, viewGroup);
            ...
            ListView lv_ccLang = (ListView) layout.findViewById(com.nile.kmooc.R.id.cc_list);
            ...
            TextView tv_none = (TextView) layout.findViewById(com.nile.kmooc.R.id.tv_cc_cancel);
            if (languageSubtitle != null) {
                tv_none.setBackgroundResource(com.nile.kmooc.R.drawable.white_bottom_rounded_selector);
            } else {
                tv_none.setBackgroundResource(com.nile.kmooc.R.color.cyan_text_navigation_20);
            }
            ...
            if (player != null) {
                if (player.isPlayingLocally()) {
                    ...
                    if(!curMessageTypes.contains(VideoNotPlayMessageType.IS_VIDEO_MESSAGE_DISPLAYED) && !player.isInError()){
                        ...
                        View errorView = getView().findViewById(com.nile.kmooc.R.id.panel_network_error);
                        errorView.setVisibility(View.VISIBLE);
                        TextView errorHeaderTextView = (TextView) errorView.findViewById(com.nile.kmooc.R.id.error_header);
                        errorHeaderTextView.setText(getString(com.nile.kmooc.R.string.wifi_off_message));
                        errorView.findViewById(com.nile.kmooc.R.id.error_message).setVisibility(View.GONE);
