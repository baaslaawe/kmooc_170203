...
public class PlayerController extends FrameLayout {
    ...
    protected View makeControllerView() {
        ...
        mRoot = inflate.inflate(com.nile.kmooc.R.layout.player_controller, null);
    ...
    private void initControllerView(View v) {
        mPauseButton = (IconImageButton) v.findViewById(com.nile.kmooc.R.id.pause);
        if (mPauseButton != null) {
            mPauseButton.requestFocus();
            mPauseButton.setOnClickListener(mPauseListener);
        }

        mFullscreenButton = (IconImageButton) v.findViewById(com.nile.kmooc.R.id.fullscreen);
        if (mFullscreenButton != null) {
            mFullscreenButton.requestFocus();
            mFullscreenButton.setOnClickListener(mFullscreenListener);
        }

        mRewButton = (ImageButton) v.findViewById(com.nile.kmooc.R.id.rewind_button);
        if (mRewButton != null) {
        ...
        mNextButton = (ImageButton) v.findViewById(com.nile.kmooc.R.id.next);
        if (mNextButton != null && !mFromXml && !mListenersSet) {
            mNextButton.setVisibility(View.GONE);
        }
        mPrevButton = (ImageButton) v.findViewById(com.nile.kmooc.R.id.prev);
        if (mPrevButton != null && !mFromXml && !mListenersSet) {
            mPrevButton.setVisibility(View.GONE);
        }

        mProgress = (ProgressBar) v.findViewById(com.nile.kmooc.R.id.mediacontroller_progress);
        if (mProgress != null) {
        ...
        mLmsButton = (ImageButton) v.findViewById(com.nile.kmooc.R.id.lms_btn);
        if (mLmsButton != null) {
            mLmsButton.requestFocus();
            mLmsButton.setOnClickListener(mLmsClickListener);
        }

        mSettingsButton = (IconImageButton) v.findViewById(com.nile.kmooc.R.id.settings);
        if (mSettingsButton != null) {
            mSettingsButton.requestFocus();
            mSettingsButton.setOnClickListener(mSettingsListener);
        }

        mEndTime = (TextView) v.findViewById(com.nile.kmooc.R.id.time);
        mCurrentTime = (TextView) v.findViewById(com.nile.kmooc.R.id.time_current);
        mFormatBuilder = new StringBuilder();
        mFormatter = new Formatter(mFormatBuilder, Locale.getDefault());

        installPrevNextListeners();

        mTitleTextView = (TextView) v.findViewById(com.nile.kmooc.R.id.video_title);
        mTopBar = v.findViewById(com.nile.kmooc.R.id.video_top_bar);
    }
    ...
    public void updatePausePlay() {
        ...
        if (mPlayer.isPlaying()) {
            mPauseButton.setImageDrawable(new IconDrawable(getContext(), FontAwesomeIcons.fa_pause)
                    .colorRes(getContext(), com.nile.kmooc.R.color.white));
            mPauseButton.setContentDescription(getContext().getResources()
                    .getString(com.nile.kmooc.R.string.video_player_pause));
        } else {
            mPauseButton.setImageDrawable(new IconDrawable(getContext(), FontAwesomeIcons.fa_play)
                    .colorRes(getContext(), com.nile.kmooc.R.color.white));
            mPauseButton.setContentDescription(getContext().getResources()
                    .getString(com.nile.kmooc.R.string.video_player_play));
        }
    }
    ...
    public void updateFullScreen() {
        ...
        if (mPlayer.isFullScreen()) {
            ...
            mFullscreenButton.setContentDescription(getContext().getResources()
                    .getString(com.nile.kmooc.R.string.video_player_exit_fullscreen));
        } else {
            mFullscreenButton.setIcon(FontAwesomeIcons.fa_expand);
            mFullscreenButton.setContentDescription(getContext().getResources()
                    .getString(com.nile.kmooc.R.string.video_player_enter_fullscreen));
        }
    }
...
//          }
    ...
    public void setSettingsBtnDrawable(boolean isSettingEnabled){
        if (mSettingsButton != null) {
            if (isSettingEnabled) {
                mSettingsButton.setIconColor(getResources().getColor(com.nile.kmooc.R.color.edx_brand_primary_accent));
            } else {
                mSettingsButton.setIconColor(getResources().getColor(com.nile.kmooc.R.color.white));
            }
        }
    }
