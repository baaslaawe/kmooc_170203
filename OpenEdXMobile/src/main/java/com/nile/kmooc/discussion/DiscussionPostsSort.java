...
public enum DiscussionPostsSort implements TextResourceProvider {
    LAST_ACTIVITY_AT(com.nile.kmooc.R.string.discussion_posts_sort_recent_activity, "last_activity_at"),
    COMMENT_COUNT(com.nile.kmooc.R.string.discussion_posts_sort_most_activity, "comment_count"),
    VOTE_COUNT(com.nile.kmooc.R.string.discussion_posts_sort_most_votes, "vote_count");
