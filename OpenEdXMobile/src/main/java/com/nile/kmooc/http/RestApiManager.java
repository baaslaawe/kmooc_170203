...
import com.nile.kmooc.http.model.CourseIdObject;
...
import com.nile.kmooc.model.course.CourseStructureJsonHandler;
...
public class RestApiManager implements IApi {
    ...
    public final OkHttpClient createSpeedTestClient() {
        ...
        int timeoutMillis = context.getResources().getInteger(com.nile.kmooc.R.integer.speed_test_timeout_in_milliseconds);
