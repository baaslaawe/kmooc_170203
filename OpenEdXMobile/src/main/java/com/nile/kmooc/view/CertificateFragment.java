...
public class CertificateFragment extends BaseFragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(com.nile.kmooc.R.menu.share_certificate, menu);
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.nile.kmooc.R.id.menu_item_share: {
                ...
                final String shareText = ResourceUtil.getFormattedString(getResources(), com.nile.kmooc.R.string.share_certificate_message, shareTextParams).toString();
                ShareUtils.showShareMenu(
                        ShareUtils.newShareIntent(shareText),
                        getActivity().findViewById(com.nile.kmooc.R.id.menu_item_share),
                ...
                com.nile.kmooc.R.string.share_certificate_popup_header);
                return true;
            }
            default: {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(com.nile.kmooc.R.layout.fragment_certificate, container, false);
        webview = (WebView) view.findViewById(com.nile.kmooc.R.id.webview);
        final View loadingIndicator = view.findViewById(com.nile.kmooc.R.id.loading_indicator);
