...
public class MyCoursesListActivity extends BaseSingleFragmentActivity {
    ...
    @NonNull
    @InjectView(com.nile.kmooc.R.id.coorinator_layout)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        configureDrawer();
        setTitle(getString(com.nile.kmooc.R.string.label_my_courses));
        environment.getSegment().trackScreenView(getString(com.nile.kmooc.R.string.label_my_courses));
    }
    ...
    public void onEvent(@NonNull final NewVersionAvailableEvent newVersionAvailableEvent) {
        if (!newVersionAvailableEvent.isConsumed()) {
            ...
            if (AppUpdateUtils.canUpdate(this)) {
                snackbar.setAction(com.nile.kmooc.R.string.app_version_update_button,
