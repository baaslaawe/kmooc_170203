...
public class CCLanguageDialogFragment extends RoboDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.nile.kmooc.R.layout.panel_cc_popup, container,
                false);
        try{
            ListView lv_ccLang = (ListView) v.findViewById(com.nile.kmooc.R.id.cc_list);
            ...
            TextView tvNone = (TextView) v.findViewById(com.nile.kmooc.R.id.tv_cc_cancel);
            if(langSelected!=null){
                if(langSelected.equalsIgnoreCase("none")){
                    tvNone.setBackgroundResource(com.nile.kmooc.R.color.cyan_text_navigation_20);
                }else{
                    tvNone.setBackgroundResource(com.nile.kmooc.R.drawable.white_bottom_rounded_selector);
                }
            }else{
                tvNone.setBackgroundResource(com.nile.kmooc.R.color.cyan_text_navigation_20);
            }
