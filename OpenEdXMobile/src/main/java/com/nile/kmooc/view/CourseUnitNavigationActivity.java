...
public class CourseUnitNavigationActivity extends CourseBaseActivity implements CourseUnitVideoFragment.HasComponent {
    ...
    @InjectView(com.nile.kmooc.R.id.goto_next)
    private Button mNextBtn;
    @InjectView(com.nile.kmooc.R.id.goto_prev)
    private Button mPreviousBtn;
    @InjectView(com.nile.kmooc.R.id.next_unit_title)
    private TextView mNextUnitLbl;
    @InjectView(com.nile.kmooc.R.id.prev_unit_title)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout insertPoint = (RelativeLayout) findViewById(com.nile.kmooc.R.id.fragment_container);
        LayoutInflater inflater = (LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE);

        View v = inflater.inflate(com.nile.kmooc.R.layout.view_course_unit_pager, null);
        insertPoint.addView(v, 0,
                new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));

        pager = (DisableableViewPager) findViewById(com.nile.kmooc.R.id.pager);
        ...
        findViewById(com.nile.kmooc.R.id.course_unit_nav_bar).setVisibility(View.VISIBLE);
    ...
    private void tryToUpdateForEndOfSequential() {
        ...
        findViewById(com.nile.kmooc.R.id.course_unit_nav_bar).requestLayout();
    ...
    private void updateUIForOrientation() {
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE && CourseUnitPagerAdapter.isCourseUnitVideo(selectedUnit)) {
            ...
            findViewById(com.nile.kmooc.R.id.course_unit_nav_bar).setVisibility(View.GONE);
