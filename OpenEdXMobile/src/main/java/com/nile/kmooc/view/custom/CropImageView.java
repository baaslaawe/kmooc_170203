...
public class CropImageView extends SubsamplingScaleImageView {
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        cropCirclePadding = getResources().getDimension(com.nile.kmooc.R.dimen.crop_circle_padding);
        setOrientation(ORIENTATION_USE_EXIF);
        setMinimumScaleType(SubsamplingScaleImageView.SCALE_TYPE_CENTER_CROP);
        borderPaint = new Paint();
        borderPaint.setColor(getResources().getColor(com.nile.kmooc.R.color.crop_circle_border_color));
        borderPaint.setStrokeWidth(getResources().getDimension(com.nile.kmooc.R.dimen.crop_circle_border_width));
        borderPaint.setStyle(Paint.Style.STROKE);
        backgroundPaint = new Paint();
        backgroundPaint.setColor(getResources().getColor(com.nile.kmooc.R.color.crop_circle_overlay_color));
    }
