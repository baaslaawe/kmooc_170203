...
public class CourseOutlineAdapter extends BaseAdapter {
    ...
    public final View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (type) {
            case SectionRow.ITEM: {
                convertView = mInflater.inflate(com.nile.kmooc.R.layout.row_course_outline_list, parent, false);
            ...
            case SectionRow.SECTION: {
                convertView = mInflater.inflate(com.nile.kmooc.R.layout.row_section_header, parent, false);
                break;
            }
            default: {
    ...
    private void getRowViewForLeaf(ViewHolder viewHolder,
        ...
        if (config.isDiscussionsEnabled() && row.component instanceof DiscussionBlockModel) {
            ...
            viewHolder.rowType.setIconColorResource(com.nile.kmooc.R.color.edx_brand_gray_accent);
        } else {
            viewHolder.bulkDownload.setVisibility(View.INVISIBLE);
        ...
        dbStore.isUnitAccessed(new DataCallback<Boolean>(true) {
            ...
            public void onResult(Boolean accessed) {
                if (accessed) {
                    ...
                    viewHolder.rowType.setIconColorResource(com.nile.kmooc.R.color.edx_brand_primary_base);
                }
            }
    ...
    private void setRowStateOnDownload(ViewHolder row, DownloadEntry.DownloadedState state
        ...
        switch (state) {
            case DOWNLOADING:
                ...
                row.bulkDownload.setIconColorResource(com.nile.kmooc.R.color.edx_brand_primary_base);
                break;
            case DOWNLOADED:
                row.bulkDownload.setIcon(FontAwesomeIcons.fa_check);
                row.bulkDownload.setIconAnimation(Animation.NONE);
                row.bulkDownload.setIconColorResource(com.nile.kmooc.R.color.edx_brand_gray_accent);
                break;
            case ONLINE:
    ...
    public View getHeaderView(int position, View convertView) {
        final SectionRow row = this.getItem(position);
        TextView titleView = (TextView) convertView.findViewById(com.nile.kmooc.R.id.row_header);
        View separator = convertView.findViewById(com.nile.kmooc.R.id.row_separator);
    ...
    public ViewHolder getTag(View convertView) {
        ...
        holder.rowType = (IconImageView) convertView
                .findViewById(com.nile.kmooc.R.id.row_type);
        holder.rowTitle = (TextView) convertView
                .findViewById(com.nile.kmooc.R.id.row_title);
        holder.rowSubtitle = (TextView) convertView
                .findViewById(com.nile.kmooc.R.id.row_subtitle);
        holder.rowSubtitleIcon = (IconImageView) convertView
                .findViewById(com.nile.kmooc.R.id.row_subtitle_icon);
        holder.rowSubtitleIcon.setIconColorResource(com.nile.kmooc.R.color.edx_brand_gray_back);
        ...
        holder.bulkDownload = (IconImageView) convertView
                .findViewById(com.nile.kmooc.R.id.bulk_download);
        holder.bulkDownload.setIconColorResource(com.nile.kmooc.R.color.edx_brand_gray_accent);
        holder.numOfVideoAndDownloadArea = (LinearLayout) convertView
                .findViewById(com.nile.kmooc.R.id.bulk_download_layout);
        holder.rowSubtitlePanel = convertView.findViewById(com.nile.kmooc.R.id.row_subtitle_panel);
        holder.halfSeparator = convertView.findViewById(com.nile.kmooc.R.id.row_half_separator);
        holder.wholeSeparator = convertView.findViewById(com.nile.kmooc.R.id.row_whole_separator);
