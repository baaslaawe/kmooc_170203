...
public class EditUserProfileFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.nile.kmooc.R.layout.fragment_edit_user_profile, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        viewHolder.username.setContentDescription(ResourceUtil.getFormattedString(getResources(), com.nile.kmooc.R.string.profile_username_description, "username", username));

        final IconDrawable icon = new IconDrawable(getActivity(), FontAwesomeIcons.fa_camera)
                .colorRes(getActivity(), com.nile.kmooc.R.color.disableable_button_text)
                .sizeRes(getActivity(), com.nile.kmooc.R.dimen.fa_x_small)
        ...
        viewHolder.changePhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                popup.getMenuInflater().inflate(com.nile.kmooc.R.menu.change_photo, popup.getMenu());
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case com.nile.kmooc.R.id.take_photo: {
                                startActivityForResult(
                                        helper.createCaptureIntent(getActivity()),
                                        CAPTURE_PHOTO_REQUEST);
                                break;
                            }
                            case com.nile.kmooc.R.id.choose_photo: {
                            ...
                            case com.nile.kmooc.R.id.remove_photo: {
    ...
    public class ViewHolder {
        ...
        public ViewHolder(@NonNull View parent) {
            this.content = parent.findViewById(com.nile.kmooc.R.id.content);
            this.loadingIndicator = parent.findViewById(com.nile.kmooc.R.id.loading_indicator);
            this.profileImage = (CircleImageView) parent.findViewById(com.nile.kmooc.R.id.profile_image);
            this.username = (TextView) parent.findViewById(com.nile.kmooc.R.id.username);
            this.fields = (ViewGroup) parent.findViewById(com.nile.kmooc.R.id.fields);
            this.changePhoto = (TextView) parent.findViewById(com.nile.kmooc.R.id.change_photo);
            this.profileImageProgress = (IconImageView) parent.findViewById(com.nile.kmooc.R.id.profile_image_progress);
        }
    }
    ...
    public void setData(@Nullable final Account account, @Nullable FormDescription formDescription) {
        ...
        if (null == account || null == formDescription) {
            ...
            viewHolder.profileImage.setBorderColorResource(viewHolder.changePhoto.isEnabled() ? com.nile.kmooc.R.color.edx_brand_primary_base : com.nile.kmooc.R.color.edx_brand_gray_accent);
                ...
                switch (field.getFieldType()) {
                    case SWITCH: {
                        ...
                        createSwitch(layoutInflater, viewHolder.fields, field, value,
                                account.requiresParentalConsent() ? getString(com.nile.kmooc.R.string.profile_consent_needed_explanation) : field.getInstructions(),
                    ...
                    case TEXTAREA: {
                        ...
                        if (TextUtils.isEmpty(text)) {
                            ...
                            if (TextUtils.isEmpty(placeholder)) {
                                displayValue = viewHolder.fields.getResources().getString(com.nile.kmooc.R.string.edit_user_profile_field_placeholder);
                            } else {
    ...
    private void executeUpdate(FormField field, String fieldValue) {
        ...
        userService.updateAccount(username, Collections.singletonMap(field.getName(), valueObject))
                .enqueue(new UserAPI.AccountDataUpdatedCallback(getActivity(), username,
    ...
    private static View createSwitch(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent, @NonNull FormField field, @NonNull String value, @NonNull String instructions, boolean readOnly, @NonNull final SwitchListener switchListener) {
        final View view = inflater.inflate(com.nile.kmooc.R.layout.edit_user_profile_switch, parent, false);
        ((TextView) view.findViewById(com.nile.kmooc.R.id.label)).setText(field.getLabel());
        ((TextView) view.findViewById(com.nile.kmooc.R.id.instructions)).setText(instructions);
        final RadioGroup group = ((RadioGroup) view.findViewById(com.nile.kmooc.R.id.options));
        {
            final RadioButton optionOne = ((RadioButton) view.findViewById(com.nile.kmooc.R.id.option_one));
            final RadioButton optionTwo = ((RadioButton) view.findViewById(com.nile.kmooc.R.id.option_two));
        ...
        if (readOnly) {
            ...
            view.setBackgroundColor(view.getResources().getColor(com.nile.kmooc.R.color.edx_brand_gray_x_back));
        } else {
    ...
    private static TextView createField(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent, @NonNull final FormField field, @NonNull final String value, boolean readOnly, @NonNull View.OnClickListener onClickListener) {
        final TextView textView = (TextView) inflater.inflate(com.nile.kmooc.R.layout.edit_user_profile_field, parent, false);
        final SpannableString formattedValue = new SpannableString(value);
        formattedValue.setSpan(new ForegroundColorSpan(parent.getResources().getColor(com.nile.kmooc.R.color.edx_brand_gray_base)), 0, formattedValue.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        textView.setText(ResourceUtil.getFormattedString(parent.getResources(), com.nile.kmooc.R.string.edit_user_profile_field, new HashMap<String, CharSequence>() {{
        ...
        if (readOnly) {
            ...
            textView.setBackgroundColor(textView.getResources().getColor(com.nile.kmooc.R.color.edx_brand_gray_x_back));
        } else {
