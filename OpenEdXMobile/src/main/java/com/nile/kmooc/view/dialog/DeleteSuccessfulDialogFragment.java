...
public class DeleteSuccessfulDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.nile.kmooc.R.layout.delete_successful_dialog, container,
                false);
        ...
        Button button = (Button) v.findViewById(com.nile.kmooc.R.id.positiveButton);
