...
public class CourseUnitDiscussionFragment extends CourseUnitFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.nile.kmooc.R.layout.fragment_course_unit_discussion, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            fragmentTransaction.add(com.nile.kmooc.R.id.content, fragment);
