...
import com.nile.kmooc.player.VideoListFragment;
...
public class VideoListActivity extends BaseVideosDownloadStateActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.nile.kmooc.R.layout.activity_video_list);
        ...
        if (playerFragment == null) {
            ...
            try {
                ...
                ft.replace(com.nile.kmooc.R.id.container_player, playerFragment, "player");
                ft.commit();
            } catch (Exception ex) {
                logger.error(ex);
            }
        ...
        listFragment = (VideoListFragment) getSupportFragmentManager()
                .findFragmentById(com.nile.kmooc.R.id.list_fragment);
    ...
    protected void onResume() {
        super.onResume();
        try {
            View container = findViewById(com.nile.kmooc.R.id.container_player);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (AppConstants.myVideosDeleteMode) {
            getMenuInflater().inflate(com.nile.kmooc.R.menu.video_list, menu);
    ...
    public boolean showInfoMessage(String message) {
        ...
        if (playerFragment.isShownWifiSettingsMessage()
                && message.equalsIgnoreCase(getString(com.nile.kmooc.R.string.wifi_off_message))) {
            return false;
        }
