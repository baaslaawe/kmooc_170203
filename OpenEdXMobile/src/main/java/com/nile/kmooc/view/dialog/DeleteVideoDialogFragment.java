...
public class DeleteVideoDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.nile.kmooc.R.layout.delete_video_dialog, container,
                false);
        TextView title_tv = (TextView) v.findViewById(com.nile.kmooc.R.id.tv_dialog_title);
        TextView dialog_tv_1 = (TextView) v
                .findViewById(com.nile.kmooc.R.id.tv_dialog_message1);

        title_tv.setText(getArguments().getString("title"));
        dialog_tv_1.setText(getArguments().getString("dialog_msg_1"));
        // Watch for button clicks.
        Button positiveBtn = (Button) v.findViewById(com.nile.kmooc.R.id.positiveButton);
        ...
        Button negativebtn = (Button) v.findViewById(com.nile.kmooc.R.id.negativeButton);
