...
public class CourseUnitVideoFragment extends CourseUnitFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.nile.kmooc.R.layout.fragment_course_unit_video, container, false);
        messageContainer = v.findViewById(com.nile.kmooc.R.id.message_container);
        return v;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (playerFragment == null) {
            ...
            try{
                ...
                ft.replace(com.nile.kmooc.R.id.player_container, playerFragment, "player");
                ft.commit();
            }catch(Exception ex){
                logger.error(ex);
            }
    ...
    private boolean checkDownloadEntry(DownloadEntry entry) {
        ...
        if (entry.isVideoForWebOnly) {
            Toast.makeText(getContext(), getString(com.nile.kmooc.R.string.video_only_on_web_short),
        ...
        if (checkDownloadEntry(entry) && !entry.isDownloaded()) {
            if (!MediaConsentUtils.canStreamMedia(getContext())) {
                ((BaseFragmentActivity) getActivity()).
                        showInfoMessage(getString(com.nile.kmooc.R.string.wifi_off_message));
            }
        }
    }
    ...
    private void showPlayer() {
        try {
            if(getView()!=null){
                View container = getView().findViewById(com.nile.kmooc.R.id.player_container);
                if (container != null) {
    ...
    private void updateUIForOrientation() {
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            LinearLayout playerContainer = (LinearLayout)getView().findViewById(com.nile.kmooc.R.id.player_container);
