...
public class DownloadListActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.nile.kmooc.R.layout.activity_downloads_list);
        ...
        final ListView downloadListView = (ListView) findViewById(com.nile.kmooc.R.id.my_downloads_list);
