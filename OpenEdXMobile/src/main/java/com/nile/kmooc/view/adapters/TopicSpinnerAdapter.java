...
public class TopicSpinnerAdapter extends ArrayAdapter<DiscussionTopicDepth> {
    ...
    private final int basePadding = getContext().getResources().getDimensionPixelSize(com.nile.kmooc.R.dimen.widget_margin);
    private final int extraPaddingPerLevel = getContext().getResources().getDimensionPixelSize(com.nile.kmooc.R.dimen.edx_margin);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        final TextView view;
        if (convertView == null) {
            view = (TextView) LayoutInflater.from(parent.getContext()).inflate(com.nile.kmooc.R.layout.edx_spinner_item, parent, false);
        } else {
        ...
        view.setText(ResourceUtil.getFormattedString(getContext().getResources(),
                com.nile.kmooc.R.string.discussion_add_post_topic_selection, "topic",
    ...
    public View getDropDownView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        final TextView view;
        if (convertView == null) {
            view = (TextView) LayoutInflater.from(parent.getContext()).inflate(com.nile.kmooc.R.layout.edx_spinner_dropdown_item, parent, false);
        } else {
            view = (TextView) convertView;
        }
        final DiscussionTopicDepth topic = getItem(position);
