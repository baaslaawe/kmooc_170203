...
public class CourseUnitWebViewFragment extends CourseUnitFragment {
    ...
    @InjectView(com.nile.kmooc.R.id.course_unit_webView)
    private WebView webView;

    @InjectView(com.nile.kmooc.R.id.content_unavailable_error_text)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.nile.kmooc.R.layout.fragment_course_unit_webview, container, false);
    }
        ...
        URLInterceptorWebViewClient client =
                new URLInterceptorWebViewClient(getActivity(), webView) {
                    ...
                    public void onReceivedError(WebView view, int errorCode,
                        ...
                        showErrorMessage(com.nile.kmooc.R.string.network_error_message,
