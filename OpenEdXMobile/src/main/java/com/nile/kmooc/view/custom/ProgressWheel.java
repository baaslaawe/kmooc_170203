...
public class ProgressWheel extends View {
    ...
    public ProgressWheel(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs,
                com.nile.kmooc.R.styleable.ProgressWheel));
    }
    ...
    private void parseAttributes(TypedArray a) {
        barWidth = (int) a.getDimension(com.nile.kmooc.R.styleable.ProgressWheel_barWidth,
                barWidth);

        rimWidth = (int) a.getDimension(com.nile.kmooc.R.styleable.ProgressWheel_rimWidth,
                rimWidth);

        spinSpeed = (int) a.getDimension(com.nile.kmooc.R.styleable.ProgressWheel_spinSpeed,
                spinSpeed);

        delayMillis = a.getInteger(com.nile.kmooc.R.styleable.ProgressWheel_delayMillis,
                delayMillis);
        if (delayMillis < 0) {
            delayMillis = 0;
        }

        barColor = a.getColor(com.nile.kmooc.R.styleable.ProgressWheel_barColor, barColor);

        barLength = (int) a.getDimension(com.nile.kmooc.R.styleable.ProgressWheel_progressBarLength,
                barLength);

        textSize = (int) a.getDimension(com.nile.kmooc.R.styleable.ProgressWheel_textSize,
                textSize);

        textColor = (int) a.getColor(com.nile.kmooc.R.styleable.ProgressWheel_textColor,
                textColor);

        //if the text is empty , so ignore it
        if (a.hasValue(com.nile.kmooc.R.styleable.ProgressWheel_text)) {
            setText(a.getString(com.nile.kmooc.R.styleable.ProgressWheel_text));
        }

        rimColor = (int) a.getColor(com.nile.kmooc.R.styleable.ProgressWheel_rimColor,
                rimColor);

        circleColor = (int) a.getColor(com.nile.kmooc.R.styleable.ProgressWheel_circleColor,
                circleColor);

        contourColor = a.getColor(com.nile.kmooc.R.styleable.ProgressWheel_contourColor, contourColor);
        contourSize = a.getDimension(com.nile.kmooc.R.styleable.ProgressWheel_contourSize, contourSize);
