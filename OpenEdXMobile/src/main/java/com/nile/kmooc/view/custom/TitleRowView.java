...
public class TitleRowView extends LinearLayout {
    ...
    private void setAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray attrArray = context.obtainStyledAttributes(attrs, com.nile.kmooc.R.styleable.TitleRowView);
        String title = attrArray.getString(com.nile.kmooc.R.styleable.TitleRowView_titleText);
        float fontSize = attrArray.getDimension(com.nile.kmooc.R.styleable.TitleRowView_titleFontSize, 12.0f);
        DecorationStyle decorationStyle =DecorationStyle.values()[attrArray.getInt(com.nile.kmooc.R.styleable.TitleRowView_decorationStyle, DecorationStyle.CENTER.ordinal())];
        int textColor = attrArray.getColor(com.nile.kmooc.R.styleable.TitleRowView_android_textColor, Color.BLACK);
        int leftColor = attrArray.getColor(com.nile.kmooc.R.styleable.TitleRowView_leftColor, com.nile.kmooc.R.color.grey_act_background);
        int rightColor = attrArray.getColor(com.nile.kmooc.R.styleable.TitleRowView_rightColor, com.nile.kmooc.R.color.grey_act_background);
