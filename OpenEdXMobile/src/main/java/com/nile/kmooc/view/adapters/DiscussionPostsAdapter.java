...
public class DiscussionPostsAdapter extends BaseListAdapter<DiscussionThread> {
    ...
    public DiscussionPostsAdapter(Context context, IEdxEnvironment environment) {
        super(context, com.nile.kmooc.R.layout.row_discussion_thread, environment);
        edx_brand_primary_base = context.getResources().getColor(com.nile.kmooc.R.color.edx_brand_primary_base);
        edx_grayscale_neutral_dark = context.getResources().getColor(com.nile.kmooc.R.color.edx_brand_gray_base);
        edx_brand_secondary_dark = context.getResources().getColor(com.nile.kmooc.R.color.edx_brand_secondary_dark);
        edx_utility_success_dark = context.getResources().getColor(com.nile.kmooc.R.color.edx_success_text);
    ...
    public void render(BaseViewHolder tag, DiscussionThread discussionThread) {
...

        {
            ...
            if (commentCount == 0) {
                ...
                final CharSequence totalReplies = ResourceUtil.getFormattedString(
                        getContext().getResources(), com.nile.kmooc.R.string.discussion_post_total_replies,
...

        {
            ...
            holder.discussionPostDateTextView.setText(ResourceUtil.getFormattedString(
                    getContext().getResources(), com.nile.kmooc.R.string.discussion_post_last_interaction_date,
                    "date", lastPostDate));
        }
    ...
    private static class ViewHolder extends BaseViewHolder {
        ...
        public ViewHolder(View convertView) {
            discussionPostTypeIcon = (IconImageView) convertView.findViewById(com.nile.kmooc.R.id.discussion_post_type_icon);
            discussionPostTitle = (TextView) convertView.findViewById(com.nile.kmooc.R.id.discussion_post_title);
            discussionPostClosedIcon = (IconImageView) convertView.findViewById(com.nile.kmooc.R.id.discussion_post_closed_icon);
            discussionPostPinIcon = (IconImageView) convertView.findViewById(com.nile.kmooc.R.id.discussion_post_pin_icon);
            discussionPostFollowIcon = (IconImageView) convertView.findViewById(com.nile.kmooc.R.id.discussion_post_following_icon);
            discussionPostRepliesTextView = (TextView) convertView.findViewById(com.nile.kmooc.R.id.discussion_post_replies_count);
            discussionPostDateTextView = (TextView) convertView.findViewById(com.nile.kmooc.R.id.discussion_post_date);
            discussionUnreadRepliesTextView = (TextView) convertView.findViewById(com.nile.kmooc.R.id.discussion_unread_replies_text);
            discussionSubtitleFirstPipe = convertView.findViewById(com.nile.kmooc.R.id.discussion_subtitle_first_pipe);
            discussionSubtitleSecondPipe = convertView.findViewById(com.nile.kmooc.R.id.discussion_subtitle_second_pipe);
        }
    }
}
