...
import com.nile.kmooc.base.FindCoursesBaseActivity;
...
public class WebViewFindCoursesActivity extends FindCoursesBaseActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.nile.kmooc.R.menu.find_courses, menu);
        // Get the SearchView and set the searchable configuration
        final MenuItem searchItem = menu.findItem(com.nile.kmooc.R.id.menu_item_search);
        searchView = (SearchView) searchItem.getActionView();

        Resources resources = getResources();
        searchView.setQueryHint(resources.getString(com.nile.kmooc.R.string.search_for_courses));
