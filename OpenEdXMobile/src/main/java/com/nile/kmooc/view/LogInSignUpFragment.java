...
import com.nile.kmooc.databinding.FragmentAuthPanelBinding;
...
public class LogInSignUpFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, com.nile.kmooc.R.layout.fragment_auth_panel, container, false);
