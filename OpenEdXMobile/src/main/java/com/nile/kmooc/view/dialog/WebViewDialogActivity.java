...
public class WebViewDialogActivity extends BaseAppActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.nile.kmooc.R.layout.fragment_web_dialog);

        final ProgressBar progress = (ProgressBar) findViewById(com.nile.kmooc.R.id.loading_indicator);
        progress.setVisibility(View.GONE);

        webView = (WebView) findViewById(com.nile.kmooc.R.id.eula_webView);
        ...
        final TextView tv_dialog_title = (TextView) findViewById(com.nile.kmooc.R.id.tv_dialog_title);
        final View viewSeperator = findViewById(com.nile.kmooc.R.id.view_seperator);
        ...
        findViewById(com.nile.kmooc.R.id.positiveButton).setOnClickListener(new OnClickListener() {
