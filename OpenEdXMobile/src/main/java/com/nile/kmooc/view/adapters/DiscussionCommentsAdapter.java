...
public class DiscussionCommentsAdapter extends RecyclerView.Adapter implements InfiniteScrollUtils.ListContentController<DiscussionComment> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == RowType.RESPONSE) {
            layout = com.nile.kmooc.R.layout.row_discussion_comments_response;
        } else {
            layout = com.nile.kmooc.R.layout.row_discussion_comments_comment;
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (position == 0) {
            ...
            holder.discussionCommentCountReportTextView.setText(context.getResources().
                    getQuantityString(com.nile.kmooc.R.plurals.number_responses_or_comments_comments_label, childCount, childCount));
            ...
            iconDrawable = new IconDrawable(context, FontAwesomeIcons.fa_flag)
                    .sizeRes(context, com.nile.kmooc.R.dimen.edx_small)
                    .colorRes(context, discussionComment.isAbuseFlagged() ? com.nile.kmooc.R.color.edx_brand_primary_base : com.nile.kmooc.R.color.edx_brand_gray_base);
            holder.discussionCommentCountReportTextView.setText(discussionComment.isAbuseFlagged() ? context.getString(com.nile.kmooc.R.string.discussion_responses_reported_label) : context.getString(com.nile.kmooc.R.string.discussion_responses_report_label));
            holder.discussionCommentCountReportTextView.setTextColor(context.getResources().getColor(com.nile.kmooc.R.color.edx_brand_gray_base));
    ...
    private static class ResponseOrCommentViewHolder extends RecyclerView.ViewHolder {
        ...
        public ResponseOrCommentViewHolder(View itemView) {
            super(itemView);
            discussionCommentRow = itemView.findViewById(com.nile.kmooc.R.id.row_discussion_comment_layout);
            discussionCommentBody = (TextView) itemView.findViewById(com.nile.kmooc.R.id.discussion_comment_body);
            discussionCommentCountReportTextView = (TextView) itemView.findViewById(com.nile.kmooc.R.id.discussion_comment_count_report_text_view);
