...
public class CropImageActivity extends BaseAppActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.nile.kmooc.R.layout.activity_crop_image);
        ...
        task = new SaveUriToFileTask(this, (Uri) getIntent().getParcelableExtra(EXTRA_IMAGE_URI)) {
            ...
            protected void onSuccess(final Uri imageUri) throws Exception {
                final CropImageView imageView = (CropImageView) findViewById(com.nile.kmooc.R.id.image);
                imageView.setImage(ImageSource.uri(imageUri));

                findViewById(com.nile.kmooc.R.id.save).setOnClickListener(new View.OnClickListener() {
                    @Override
        ...
        findViewById(com.nile.kmooc.R.id.cancel).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onBackPressed();
            }
