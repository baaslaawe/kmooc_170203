...
public class NetworkCheckDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.nile.kmooc.R.layout.dialog_wifi_confirm,
                container, false);
        ...
        Button positiveButton = (Button) v.findViewById(com.nile.kmooc.R.id.positiveButton);
        ...
        Button negativeButton = (Button) v.findViewById(com.nile.kmooc.R.id.negativeButton);
