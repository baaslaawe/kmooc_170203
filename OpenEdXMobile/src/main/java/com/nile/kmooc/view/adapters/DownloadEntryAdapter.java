...
public abstract class DownloadEntryAdapter extends BaseListAdapter<DownloadEntryAdapter.Item> {
    ...
    public DownloadEntryAdapter(Context context, IEdxEnvironment environment) {
        super(context, com.nile.kmooc.R.layout.row_download_list, environment);
    }
    ...
    public void render(BaseViewHolder tag, final Item item) {
        ...
        switch (item.getStatus()) {
            case PENDING: {
                progressText = getContext().getString(com.nile.kmooc.R.string.download_pending);
                progressDrawable = com.nile.kmooc.R.drawable.custom_progress_bar_horizontal_success;
                errorText = null;
                break;
            }
            case DOWNLOADING: {
            ...
            case FAILED: {
                errorText = getContext().getString(com.nile.kmooc.R.string.error_download_failed);
                progressDrawable = com.nile.kmooc.R.drawable.custom_progress_bar_horizontal_error;
    ...
    private static class ViewHolder extends BaseViewHolder {
        ...
        public ViewHolder(@NonNull View view) {
            title = (TextView) view.findViewById(com.nile.kmooc.R.id.downloads_name);
            duration = (TextView) view
                    .findViewById(com.nile.kmooc.R.id.download_time);
            percent = (TextView) view
                    .findViewById(com.nile.kmooc.R.id.download_percentage);
            error = (TextView) view
                    .findViewById(com.nile.kmooc.R.id.txtDownloadFailed);
            progress = (ProgressBar) view
                    .findViewById(com.nile.kmooc.R.id.progressBar);
            cross_image_layout = (LinearLayout) view
                    .findViewById(com.nile.kmooc.R.id.close_btn_layout);
        }
    }
