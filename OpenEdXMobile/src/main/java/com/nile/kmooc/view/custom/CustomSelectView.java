...
public class CustomSelectView<T> extends AppCompatTextView implements View.OnClickListener,
    ...
    private void showHint() {
        setText(hint);
        setTextColor(getResources().getColor(com.nile.kmooc.R.color.hint_grey_text));
        setContentDescription(getResources().getString(com.nile.kmooc.R.string.dropdown_list_prefix) + hint);
    }
    ...
    protected void select(T item) {
        ...
        if (TextUtils.isEmpty(item.toString())
            ...
            setTextColor(getResources().getColor(com.nile.kmooc.R.color.grey_text));
            setContentDescription(getResources().getString(com.nile.kmooc.R.string.dropdown_list_prefix) + item.toString());
        }
    }
