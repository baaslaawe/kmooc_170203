...
import com.nile.kmooc.task.EnrollForCourseTask;
import com.nile.kmooc.task.GetEnrolledCourseTask;
...
public class CourseDetailFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mCourseTextName = (TextView) view.findViewById(com.nile.kmooc.R.id.course_detail_name);
        mCourseTextDetails = (TextView) view.findViewById(com.nile.kmooc.R.id.course_detail_extras);
        mHeaderImageView = (ImageView) view.findViewById(com.nile.kmooc.R.id.header_image_view);
        mHeaderPlayIcon = (ImageView) view.findViewById(com.nile.kmooc.R.id.header_play_icon);
        mCourseDetailLayout = (LinearLayout) view.findViewById(com.nile.kmooc.R.id.dashboard_detail);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        final View child = inflater.inflate(com.nile.kmooc.R.layout.fragment_course_detail, mCourseDetailLayout, false);
        mShortDescription = (TextView) child.findViewById(com.nile.kmooc.R.id.course_detail_short_description);
        ...
        // Enrollment Button
        mEnrollButton = (Button) child.findViewById(com.nile.kmooc.R.id.button_enroll_now);
        configureEnrollButton();

        // Course Detail Fields - Each field will be created manually.

        courseDetailFieldLayout = (LinearLayout) view.findViewById(com.nile.kmooc.R.id.course_detail_fields);
        if (courseDetail.effort != null && !courseDetail.effort.isEmpty()) {
            ...
            holder.rowFieldName.setText(com.nile.kmooc.R.string.effort_field_name);
            holder.rowFieldText.setText(courseDetail.effort);
        }

        //  About this Course
        courseAbout = (FrameLayout) view.findViewById(com.nile.kmooc.R.id.course_detail_course_about);
        courseAboutWebView = (EdxWebView) courseAbout.findViewById(com.nile.kmooc.R.id.course_detail_course_about_webview);
    }
    ...
    private ViewHolder createCourseDetailFieldViewHolder(LayoutInflater inflater, LinearLayout parent) {
        ...
        holder.rowView = inflater.inflate(com.nile.kmooc.R.layout.course_detail_field, parent, false);

        holder.rowIcon = (IconImageView) holder.rowView.findViewById(com.nile.kmooc.R.id.course_detail_field_icon);
        holder.rowFieldName = (TextView) holder.rowView.findViewById(com.nile.kmooc.R.id.course_detail_field_name);
        holder.rowFieldText = (TextView) holder.rowView.findViewById(com.nile.kmooc.R.id.course_detail_field_text);
    ...
    private void configureEnrollButton() {
        ...
        if (mEnrolled) {
            mEnrollButton.setText(com.nile.kmooc.R.string.view_course_button_text);
        } else {
            mEnrollButton.setText(com.nile.kmooc.R.string.enroll_now_button_text);
        }
    ...
    public void enrollInCourse() {
        ...
        EnrollForCourseTask enrollForCourseTask = new EnrollForCourseTask(getActivity(),
            ...
            public void onSuccess(Void result) {
                ...
                mEnrollButton.setText(com.nile.kmooc.R.string.view_course_button_text);
                Toast.makeText(getContext(), com.nile.kmooc.R.string.you_are_now_enrolled, Toast.LENGTH_SHORT).show();
            ...
            public void onException(Exception ex) {
                ...
                Toast.makeText(getContext(), com.nile.kmooc.R.string.enrollment_failure, Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private void openCourseDashboard() {
        ...
        try {
            ...
            Toast.makeText(getContext(), com.nile.kmooc.R.string.cannot_show_dashboard, Toast.LENGTH_SHORT).show();
        }
