...
public class AuthorLayoutViewHolder {
    ...
    public AuthorLayoutViewHolder(View itemView) {
        ...
        profileImageView = (ImageView) itemView.findViewById(com.nile.kmooc.R.id.profile_image);
        authorTextView = (TextView) itemView.findViewById(com.nile.kmooc.R.id.discussion_author_text_view);
        dateTextView = (TextView) itemView.findViewById(com.nile.kmooc.R.id.discussion_date_text_view);
        answerTextView = (TextView) itemView.findViewById(com.nile.kmooc.R.id.discussion_responses_answer_text_view);
        ...
        TextViewCompat.setCompoundDrawablesRelativeWithIntrinsicBounds(
                ...
                new IconDrawable(context, FontAwesomeIcons.fa_check_square_o)
                        ...
                        .colorRes(context, com.nile.kmooc.R.color.edx_success_accent),
                null, null, null);
    ...
    public void populateViewHolder(@NonNull Config config, @NonNull IAuthorData authorData,
        ...
        final ProfileImage profileImage;
        {
            ...
            if (profileImage != null && profileImage.hasImage()) {
                ...
                profileImageView.setImageResource(com.nile.kmooc.R.drawable.profile_photo_placeholder);
            }
        }
