...
public abstract class ChapterAdapter extends BaseListAdapter<SectionEntry> {
    ...
    public ChapterAdapter(Context context, String courseId, IEdxEnvironment environment) {
        super(context, com.nile.kmooc.R.layout.row_chapter_list, environment);
    ...
    public void render(BaseViewHolder tag, final SectionEntry model) {
        ...
        if (!NetworkUtil.isConnected(context)) {
            ...
            {
                holder.next_arrow.setBackgroundResource(com.nile.kmooc.R.drawable.ic_next_default_mirrored);
                holder.chapterLayout.setBackgroundResource(com.nile.kmooc.R.drawable.list_item_overlay_selector);
                holder.chapterName.setTextColor(context.getResources()
                        .getColor(com.nile.kmooc.R.color.grey_text_mycourse));
            }else{
                holder.next_arrow
                .setBackgroundResource(com.nile.kmooc.R.drawable.ic_next_deactive_mirrored);
                holder.chapterLayout
                        .setBackgroundResource(com.nile.kmooc.R.color.disabled_chapter_list);
                holder.chapterName.setTextColor(context.getResources()
                        .getColor(com.nile.kmooc.R.color.light_gray));
            }
            ...
            holder.chapterName.setTextColor(context.getResources().getColor(
                    com.nile.kmooc.R.color.grey_text_mycourse));
        }
    }
    ...
    public BaseViewHolder getTag(View convertView) {
        ...
        holder.chapterName = (TextView) convertView
                .findViewById(com.nile.kmooc.R.id.chapter_name);
        ...
        holder.next_arrow = (ImageView) convertView
                .findViewById(com.nile.kmooc.R.id.next_arrow);
        holder.chapterLayout = (RelativeLayout) convertView
                .findViewById(com.nile.kmooc.R.id.chapter_row_layout);
        holder.download_pw = (ProgressWheel) convertView.
                findViewById(com.nile.kmooc.R.id.progress_wheel);
        holder.progresslayout = (LinearLayout) convertView
                .findViewById(com.nile.kmooc.R.id.download_progress);
        return holder;
    }
