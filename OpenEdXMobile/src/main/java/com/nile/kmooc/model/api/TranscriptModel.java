...
public class TranscriptModel implements Serializable {
    ...
    public LinkedHashMap<String, String> getLanguageList(Context context) {
        ...
        if (chineseUrl != null) {
            languageArray.put(context.getString(com.nile.kmooc.R.string.cc_chinese_code),
                    context.getString(com.nile.kmooc.R.string.lbl_cc_chinese));
        }
        if (englishUrl != null) {
            languageArray.put(context.getString(com.nile.kmooc.R.string.cc_english_code),
                    context.getString(com.nile.kmooc.R.string.lbl_cc_english));
        }
        if (frenchUrl != null) {
            languageArray.put(context.getString(com.nile.kmooc.R.string.cc_french_code),
                    context.getString(com.nile.kmooc.R.string.lbl_cc_french));
        }
        if (germanUrl != null) {
            languageArray.put(context.getString(com.nile.kmooc.R.string.cc_german_code),
                    context.getString(com.nile.kmooc.R.string.lbl_cc_german));
        }
        if (portugueseUrl != null) {
            languageArray.put(context.getString(com.nile.kmooc.R.string.cc_portugal_code),
                    context.getString(com.nile.kmooc.R.string.lbl_cc_portugal));
        }
        if (spanishUrl != null) {
            languageArray.put(context.getString(com.nile.kmooc.R.string.cc_spanish_code),
                    context.getString(com.nile.kmooc.R.string.lbl_cc_spanish));
        }
        if (koreanUrl != null) {
            languageArray.put(context.getString(com.nile.kmooc.R.string.cc_korean_code),
                    context.getString(com.nile.kmooc.R.string.lbl_cc_korean));
        }
    ...
    public boolean equals(Object o) {
        ...
        if (chineseUrl != null ? !chineseUrl.equals(that.chineseUrl) : that.chineseUrl != null)
            return false;
        if (koreanUrl != null ? !koreanUrl.equals(that.koreanUrl) : that.koreanUrl != null)
            return false;
