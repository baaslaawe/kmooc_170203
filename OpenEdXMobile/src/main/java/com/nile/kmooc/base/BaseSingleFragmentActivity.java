...
public abstract class BaseSingleFragmentActivity extends BaseFragmentActivity implements TaskProcessCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.nile.kmooc.R.layout.activity_single_fragment_base);
    ...
    private void loadFirstFragment() throws Exception {
        ...
        fragmentTransaction.add(com.nile.kmooc.R.id.my_groups_list_container, singleFragment, FIRST_FRAG_TAG);
