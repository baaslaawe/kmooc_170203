...
public abstract class FindCoursesBaseActivity extends BaseFragmentActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webview = (WebView) findViewById(com.nile.kmooc.R.id.webview);
        offlineBar = findViewById(com.nile.kmooc.R.id.offline_bar);
        progressWheel = (ProgressBar) findViewById(com.nile.kmooc.R.id.loading_indicator);
    ...
    private void showOfflineMessage() {
        ...
        TextView offlineModeTv = (TextView) findViewById(com.nile.kmooc.R.id.offline_mode_message);
    ...
    public void onClickEnroll(final String courseId, final boolean emailOptIn) {
        ...
        EnrollForCourseTask enrollForCourseTask = new EnrollForCourseTask(FindCoursesBaseActivity.this,
            ...
            public void onSuccess(Void result) {
                ...
                Toast.makeText(FindCoursesBaseActivity.this, context.getString(com.nile.kmooc.R.string.you_are_now_enrolled), Toast.LENGTH_SHORT).show();
    ...
    private void showEnrollErrorMessage(final String courseId, final boolean emailOptIn) {
        if (isActivityStarted()) {
            ...
            dialogMap.put("message_1", getString(com.nile.kmooc.R.string.enrollment_failure));

            dialogMap.put("yes_button", getString(com.nile.kmooc.R.string.try_again));
