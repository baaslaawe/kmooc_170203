...
import com.nile.kmooc.view.NavigationFragment;
...
public abstract class BaseFragmentActivity extends BaseAppActivity
            ...
            if (mDrawerLayout != null) {
                ...
                if (frag == null) {
                    getSupportFragmentManager().beginTransaction()
                            .replace(com.nile.kmooc.R.id.slider_menu,
    ...
    public void onBackPressed() {
        DrawerLayout mDrawerLayout = (DrawerLayout) findViewById(com.nile.kmooc.R.id.drawer_layout);
    ...
    protected void configureDrawer() {
        ...
        if (mDrawerLayout != null) {
            getSupportFragmentManager().beginTransaction()
                    .replace(com.nile.kmooc.R.id.slider_menu, new NavigationFragment(),
                            "NavigationFragment").commit();

            mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
                    com.nile.kmooc.R.string.label_open_navigation_menu, com.nile.kmooc.R.string.label_close_navigation_menu) {
    ...
    protected boolean createOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.nile.kmooc.R.menu.main, menu);
        offlineMenuItem = menu.findItem(com.nile.kmooc.R.id.offline);
    ...
    public boolean showInfoMessage(String message) {
        TextView infoMessageTv = (TextView) findViewById(com.nile.kmooc.R.id.flying_message);
    ...
    public boolean hideInfoMessage() {
        View messageView = findViewById(com.nile.kmooc.R.id.flying_message);
        if (messageView == null) {
    ...
    public void showOfflineAccessMessage() {
        try {
            animateLayouts(findViewById(com.nile.kmooc.R.id.offline_access_panel));
        } catch (Exception e) {
            logger.error(e);
        }
    }
    ...
    public boolean showErrorMessage(String header, String message, boolean isPersistent) {
        LinearLayout error_layout = (LinearLayout) findViewById(com.nile.kmooc.R.id.error_layout);
        if (error_layout == null) {
            logger.warn("Error Layout not available, so couldn't show flying message");
            return false;
        }
        TextView errorHeader = (TextView) findViewById(com.nile.kmooc.R.id.error_header);
        TextView errorMessageView = (TextView) findViewById(com.nile.kmooc.R.id.error_message);
