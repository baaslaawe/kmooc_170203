...
public abstract class BaseVideosDownloadStateActivity extends BaseFragmentActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.nile.kmooc.R.menu.download_state, menu);
        MenuItem newProgressMenuItem = menu.findItem(com.nile.kmooc.R.id.download_progress);
        View progressView = newProgressMenuItem.getActionView();
        ProgressWheel newProgressWheel = (ProgressWheel)
                progressView.findViewById(com.nile.kmooc.R.id.progress_wheel);
