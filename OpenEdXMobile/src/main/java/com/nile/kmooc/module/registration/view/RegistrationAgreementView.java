...
class RegistrationAgreementView implements IRegistrationFieldView {
    ...
    public RegistrationAgreementView(RegistrationFormField field, View view) {
        ...
        this.mInputView = (TextView) view.findViewById(com.nile.kmooc.R.id.txt_input);
        this.mInstructionView = (TextView)view.findViewById(com.nile.kmooc.R.id.txt_input_instruction);
        this.mErrorView = (TextView) view.findViewById(com.nile.kmooc.R.id.txt_input_error);
