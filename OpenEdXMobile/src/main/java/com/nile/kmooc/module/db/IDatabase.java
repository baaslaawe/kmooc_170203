...
public interface IDatabase {
     ...
     */
    Integer updateVideoWatchedState(String videoId, DownloadEntry.WatchedState state,
                                    DataCallback<Integer> callback);
     ...
     * @param dataCallback
     */
    DownloadEntry.WatchedState getWatchedStateForVideoId(String videoId,
                                                         DataCallback<DownloadEntry.WatchedState> dataCallback);
     ...
     * @param dataCallback
     */
    DownloadEntry.DownloadedState getDownloadedStateForVideoId(String videoId,
                                                               DataCallback<DownloadEntry.DownloadedState> dataCallback);
