...
class RegistrationCheckBoxView implements IRegistrationFieldView {
    ...
    public RegistrationCheckBoxView(RegistrationFormField field, View view) {
        ...
        this.mInputView = (CheckBox) view.findViewById(com.nile.kmooc.R.id.checkbox_input);
        this.mInstructionsView = (TextView)view.findViewById(com.nile.kmooc.R.id.checkbox_input_instructions);
        this.mErrorView = (TextView) view.findViewById(com.nile.kmooc.R.id.checkbox_input_error);
