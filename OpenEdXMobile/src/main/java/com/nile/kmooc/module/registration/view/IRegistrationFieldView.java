    ...
    public static class Factory {
        ...
        public static IRegistrationFieldView getInstance(LayoutInflater inflater, RegistrationFormField field) {
            ...
            if (fieldType.equals(RegistrationFieldType.EMAIL)) {
                View view = inflater.inflate(com.nile.kmooc.R.layout.view_register_edit_text, null);
                ...
                View view = inflater.inflate(com.nile.kmooc.R.layout.view_register_spinner, null);
                ...
                if (field.getAgreement() != null) {
                    View view = inflater.inflate(com.nile.kmooc.R.layout.view_register_agreement, null);
                    return new RegistrationAgreementView(field, view);
                }
                else {
                    View view = inflater.inflate(com.nile.kmooc.R.layout.view_register_checkbox, null);
