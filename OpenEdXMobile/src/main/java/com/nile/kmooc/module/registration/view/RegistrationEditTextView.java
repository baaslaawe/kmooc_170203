...
class RegistrationEditTextView implements IRegistrationFieldView {
    ...
    public RegistrationEditTextView(RegistrationFormField field, View view) {
        ...
        mTextInputLayout = (TextInputLayout) view.findViewById(com.nile.kmooc.R.id.register_edit_text_til);
        mTextInputEditText = (TextInputEditText) view.findViewById(com.nile.kmooc.R.id.register_edit_text_tilEt);
        mInstructionsTextView = (TextView) view.findViewById(com.nile.kmooc.R.id.input_instructions);
        mErrorTextView = (TextView) view.findViewById(com.nile.kmooc.R.id.input_error);
    ...
    public boolean isValidInput() {
        ...
        if (mField.isRequired() && !hasValue()) {
            ...
            if(errorMessage==null || errorMessage.isEmpty()){
                errorMessage = getView().getResources().getString(com.nile.kmooc.R.string.error_enter_field,
                        mField.getLabel());
            }
        ...
        if (inputLength < mField.getRestriction().getMinLength()) {
            ...
            if(errorMessage==null || errorMessage.isEmpty()){
                errorMessage = getView().getResources().getString(com.nile.kmooc.R.string.error_min_length,
        ...
        if (mField.getRestriction().getMaxLength() > 0
            ...
            if(errorMessage==null || errorMessage.isEmpty()){
                errorMessage = getView().getResources().getString(com.nile.kmooc.R.string.error_max_length,
