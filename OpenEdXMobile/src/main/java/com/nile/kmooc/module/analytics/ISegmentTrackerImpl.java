...
public class ISegmentTrackerImpl implements ISegmentTracker {
    ...
    public ISegmentTrackerImpl(Context context, Config config) {
        try {
            ...
            boolean debugging = context.getResources().getBoolean(com.nile.kmooc.R.bool.analytics_debug);
            int queueSize = context.getResources().getInteger(com.nile.kmooc.R.integer.analytics_queue_size);
            int flushInterval = context.getResources().getInteger(com.nile.kmooc.R.integer.analytics_flush_interval);
