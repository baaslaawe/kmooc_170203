...
public class MediaConsentUtils {
    ...
    public static void showLeavingAppDataDialog(final FragmentActivity activity, final IDialogCallback consentCallback){
        ...
        if (connectedToWifi) {
            ...
            CharSequence platformName = activity.getString(com.nile.kmooc.R.string.platform_name);
            String title = ResourceUtil.getFormattedString(activity.getResources(), com.nile.kmooc.R.string.leaving_app_data_title, "platform_name", platformName).toString();
            String message = ResourceUtil.getFormattedString(activity.getResources(), com.nile.kmooc.R.string.leaving_app_data_message, "platform_name", platformName).toString();
            String positiveLabel = activity.getString(com.nile.kmooc.R.string.label_ok);
            String negativeLabel = activity.getString(com.nile.kmooc.R.string.label_cancel);
