...
public class UiUtil {
    ...
    public static void showMessage(View root, String message){
        ...
        TextView downloadMessageTv = (TextView) root.findViewById(com.nile.kmooc.R.id.flying_message);
    ...
    public static void showOfflineAccessMessage(View root) {
        ...
        try {
            ViewAnimationUtil.showMessageBar(root.findViewById(com.nile.kmooc.R.id.offline_access_panel));
        } catch (Exception e) {
            logger.error(e);
        }
    }
    ...
    public static void hideOfflineAccessMessage(View root) {
        ...
        View v = root.findViewById(com.nile.kmooc.R.id.offline_access_panel);
        if (v != null) {
