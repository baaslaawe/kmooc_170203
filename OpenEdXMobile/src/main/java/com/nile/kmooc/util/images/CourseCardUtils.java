    ...
    public static String getFormattedDate(Context context, String start, String end, StartType start_type, String start_display) {
        ...
        if (isStarted(start)) {
            ...
            if (endDate == null) {
                ...
                formattedDate = ResourceUtil.getFormattedString(context.getResources(), com.nile.kmooc.R.string
            ...
            if (start_type == StartType.TIMESTAMP && !TextUtils.isEmpty(start)) {
                ...
                formattedDate = ResourceUtil.getFormattedString(context.getResources(), com.nile.kmooc.R.string
                        .label_starting, "date", context.getString(com.nile.kmooc.R.string.assessment_soon));
            }
        }
