...
public class MediaCodecAudioTrackRenderer extends MediaCodecTrackRenderer {
  ...
  @Override
  protected boolean processOutputBuffer(long timeUsUnused, MediaCodec codec, ByteBuffer buffer,
    ...
    if (bytesToWrite > 0) {
      ...
      // rohan's code: update speed of the track
      int sampleRateInHz = (int) (sampleRate * playbackSpeed);
